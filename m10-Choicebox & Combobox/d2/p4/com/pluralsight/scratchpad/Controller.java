...
public class Controller extends BaseController {
    ...
    private void prepareImageCombo() {
        list.forEach(continent -> imageCombo.getItems().add(continent.getName()));
        imageCombo.setCellFactory(param -> new ContinentCell());
        imageCombo.setButtonCell(new ContinentCell());
    }
    ...
    private void prepareContinentCombo() {
        ...
        comboBox.setOnAction(event -> log("Changed first choice box " + comboBox.getValue()));
